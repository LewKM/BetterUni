				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" action="profile.php" method="post" >
								<div class="">
									...
									<div class="form-group row">
										...
										$email = $_POST[''];
										$records = mysqli_query($db,"select name from student where email = $email"); // fetch data from database
